...
(function () {
    if (typeof JSZip !== 'undefined') {
        ...
        */
        ...
        JSZip.prototype.genZip = function genZip() {
            const thisZip = this;
  ...
  * @param {{ onload: Function, onerror: Function, element: {}, mainDirectory: string, fileExtension: null }} originalOptions
 *  Having the element could be helpful getting it's ATTRIBUTES (such as: "download-name")
 */
function download(fileUrl, fileName, directory = '', originalOptions = {}) {
    const o = $.extend({
        onload: function () {
        },
        onerror: function (r) {
    ...
    if (fileName && fileName.length > 1) { // if fileName passed
        ...
        if (o.element === 'object') { // element passed
            const nameAttribute = Config.NAME_ATTRIBUTES[0];
    ...
    if (directory && directory.length > 1) {// if downloadDirectory passed
...
function anchorClick(href, downloadValue, target) {
    downloadValue = downloadValue || nameFile(href);
